...
class Filosofos implements Runnable {
    // Usado para variar quanto tempo um filosofo pensa antes de comer 
    ...
    // Ciclo infinito de cada filosofo executado em threads separadas
    @Override
    public void run() {
    ...
    // Modelo de pensamento. Define um tempo aleatorio pro filosofo fazer isso
    ...
    private void pegarGarfo_direito()  throws InterruptedException{
        ...
        System.out.println("Filosofo " + id + " esta SEGURANDO o garfo direito.\n");
    }
